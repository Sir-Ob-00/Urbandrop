              ...
              <AnimatePresence mode="wait">
                {getVisibleSlides().map((slide, index) => (
                  <motion.div
                    ...
                    className={`absolute inset-0 flex items-center justify-center ${slide.isCenter ? 'z-20' : 'z-10'
                      }`}
                    initial={{
              ...
              <div className="flex space-x-2">
                {categories.map((_, index) => (
                  <motion.button
                    ...
                    className={`w-3 h-3 rounded-full transition-colors duration-300 ${index === currentIndex ? 'bg-[#5CB35E]' : 'bg-gray-300'
                      }`}
