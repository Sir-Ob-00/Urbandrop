...
const countries = [
  ...
  },
  {
    name: 'Ghana',
    flag: GhanaFlag,
    groceries: [GhanaImg1, GhanaImg2, GhanaImg3]
  },
  {
    name: 'India',
    flag: IndiaFlag,
    groceries: [IndiaImg1, IndiaImg2, IndiaImg3]
  },
  {
    name: 'Jamaica',
    flag: JamaicaFlag,
    groceries: [JamaicaImg1, JamaicaImg2, JamaicaImg3, JamaicaImg4]
  },
  {
    name: 'Kenya',
    flag: KenyaFlag,
  ...
  },
  {
    name: 'Morocco',
    flag: MoroccoFlag,
    groceries: [MoroccoImg1, MoroccoImg2, MoroccoImg3, MoroccoImg4]
  },
  {
    name: 'Nigeria',
    flag: NigeriaFlag,
    groceries: [NigeriaImg1, NigeriaImg2, NigeriaImg3, NigeriaImg4]
  },
  {
    name: 'Pakistan',
    flag: PakistanFlag,
    groceries: [PakistanImg1, PakistanImg2, PakistanImg3]
  },
  {
    name: 'Senegal',
    flag: SenegalFlag,
  ...
  },
  {
    ...
    groceries: [SouthAfricaImg1, SouthAfricaImg2, SouthAfricaImg3]
  },
  {
    name: 'Zimbabwe',
    flag: ZimbabweFlag,
    groceries: [ZimbabweImg1, ZimbabweImg2, ZimbabweImg3]
  }
];
