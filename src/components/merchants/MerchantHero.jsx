      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 relative z-10 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center pt-4">
            <a href="https://merchant.urbandrop.io/signup/" className="bg-primary text-white px-10 py-5 rounded-full font-bold text-lg transition-all transform hover:scale-105 shadow-2xl">
