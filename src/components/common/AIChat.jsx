    ...
    useEffect(() => {
        fetch(API_BASE_URL)
            ...
            .catch(err => {
                ...
                const fallback = 'Welcome to the UrbanDrop!. Click on the Chat Icon to start chatting!.';
                ...
                {isOpen && (
                    < >
                        ...
                        <motion.div
                            ...
                            className="fixed bottom-4 right-4 md:bottom-24 md:right-8 h-[65vh] w-[90vw] md:w-[360px] md:h-[500px] bg-gray-50 flex flex-col rounded-2xl overflow-hidden shadow-2xl z-50"
                        >
                            {/* Header */}
