...
export default function FinalPage({ yn, setYn, oneChange, setOneChange, anythingElse, setAnythingElse, onBack, onSubmit, disabled }) {
  return (
    <div style={styles.page}>
      ...
      <NavBar onBack={onBack} onSubmit={onSubmit} disabled={disabled} />
    </div>
  );
}
