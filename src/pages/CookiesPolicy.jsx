		...
		<main className="bg-white pt-32 pb-16">
			...
			<div className="container mx-auto px-6">
				<div className="text-center mb-16">
					<h1 className="font-extrabold text-dark">{t('cookiesPolicy.title')}</h1>
				...
				<div className="max-w-5xl mx-auto">
					...
					>
						<h2 className="text-[#183A37] mb-3">{t('cookiesPolicy.whatAreCookies.title')}</h2>
					...
					>
						...
						>
							...
							<h3 className="text-dark mb-2">{t('cookiesPolicy.types.essential.title')}</h3>
						...
						>
							...
							<h3 className="text-[#183A37] mb-2">{t('cookiesPolicy.types.performance.title')}</h3>
						...
						>
							...
							<h3 className="text-[#183A37] mb-2">{t('cookiesPolicy.types.functionality.title')}</h3>
						...
						>
							...
							<h3 className="text-[#183A37] mb-2">{t('cookiesPolicy.types.advertising.title')}</h3>
					...
					>
						<h2 className="text-[#183A37] mb-3">{t('cookiesPolicy.thirdParty.title')}</h2>
						<p>{t('cookiesPolicy.thirdParty.desc')}</p>

						<h2 className="text-[#183A37] mb-3 mt-8">{t('cookiesPolicy.managing.title')}</h2>
						<p>{t('cookiesPolicy.managing.desc')}</p>

						<h2 className="text-[#183A37] mb-3 mt-8">{t('cookiesPolicy.consent.title')}</h2>
						<p>{t('cookiesPolicy.consent.desc')}</p>

						<h2 className="text-[#183A37] mb-3 mt-8">{t('cookiesPolicy.updates.title')}</h2>
						<p>{t('cookiesPolicy.updates.desc')}</p>

						<h2 className="text-[#183A37] mb-3 mt-8">{t('cookiesPolicy.contact.title')}</h2>
