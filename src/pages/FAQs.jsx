		...
		<main className="bg-background py-16 min-h-screen">
			<div className="container mx-auto px-6">
				<div className="text-center mb-16">
					...
					<p className="text-muted mt-2">Find answers to the most common questions about Urbandrop.</p>
				</div>
          ...
          <div className="bg-white rounded-lg shadow-xl overflow-hidden">
            {faqCategories.find(cat => cat.category === activeCategory)?.faqs.map((faq, index) => (
              <AccordionItem key={index} question={faq.question} answer={faq.answer} />
				...
				<div className="text-center mt-16 bg-white p-8 rounded-lg shadow-lg max-w-3xl mx-auto">
					<h3 className="text-2xl font-bold text-dark mb-3">Can't find the answer you're looking for?</h3>
					<p className="text-muted mb-6">Our support team is here to help. Get in touch with us for any questions.</p>
